        ...
        _renderTemplate:function (data) {
            ...
            for (var i = 0, tmpList; tmpList = data[i++];) {
                ...
                if (i == 1) {
                    ...
                    if (data.length != 1) {
                        t.push('<div id="page' + i + '" ontouchend="" onclick="music.onpageclick(' + i + ')" class="pageon">' + (i ) + '</div>');
                    }
                } else {
                    s.push('<div id="panel' + i + '" class="paneloff">');
                    t.push('<div id="page' + i + '" ontouchend="" onclick="music.onpageclick(' + i + ')" class="pageoff">' + (i ) + '</div>');
                }
                ...
                for (var j = 0, tmpObj; tmpObj = tmpList[j++];) {
                    ...
                    s.push('<input type="radio" id="radio-' + i + '-' + j + '" name="musicId" class="m-l" ontouchend="" onclick="music.doselect(' + (me.pageSize * (i-1) + (j-1)) + ')"/>');
                    ...
                    s.push('<span class="m-try" ontouchend="" onclick="music.doselect(' + (me.pageSize * (i-1) + (j-1)) + ');music.listenTest(this)"></span>');
                    s.push('</label>');
                }
                s.push('</div>');
                s.push('</div>');
